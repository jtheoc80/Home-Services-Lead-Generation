...
def test_contractor_trial_workflow():
    ...
    try:
        ...
        cursor.execute("SELECT * FROM contractors WHERE email = ?", ("john@example.com",))
        ...
        assert contractor[10] == "1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa", "Crypto address should be stored"
