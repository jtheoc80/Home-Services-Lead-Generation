...
class SocrataAdapter:
    ...
    def _parse_record(self, record: Dict[str, Any]) -> Optional[PermitRecord]:
        ...
        try:
            ...
            permit_data = {
                "permit_id": mapped_data.get("permit_id")
                or record.get("permit_number")
                or record.get("id"),
                "address": mapped_data.get("address") or record.get("address") or "",
                "description": mapped_data.get("description")
                or record.get("work_description")
                or "",
                "applicant": mapped_data.get("applicant")
                or record.get("contractor_name")
                or "",
                "value": self._parse_value(
                    mapped_data.get("value") or record.get("estimated_cost")
                ),
                "work_class": mapped_data.get("work_class")
                or record.get("permit_type")
                or "",
                "issue_date": self._parse_date(
                    mapped_data.get("issue_date") or record.get(self.date_field)
                ),
