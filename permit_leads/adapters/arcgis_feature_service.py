        ...
        normalized.update(
            {
                ...
                or row.get("PERMITNUMBER")
                or row.get("permit_id")
                or "",
                "issued_date": normalized.get("issued_date")
                or row.get("ISSUEDDATE")
                or row.get("issue_date")
                or "",
                "address": normalized.get("address")
                or row.get("FULLADDRESS")
                or row.get("full_address")
                or "",
                "description": normalized.get("description")
                or row.get("PERMITNAME")
                ...
                or row.get("APPLICANTNAME")
                or "",
                "value": self._parse_value(
                    normalized.get("value") or row.get("PERMITVALUATION")
                ),
                "raw_json": row,
            }
        )
