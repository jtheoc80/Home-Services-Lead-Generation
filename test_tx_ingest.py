...
def test_feature_flags():
    ...
    assert feature_flags.use_entity_resolution, "Entity resolution should be enabled by default"
...
def test_pipeline_imports():
    ...
    try:
        from pipelines.normalize import DataNormalizer
...
def test_entity_resolution_import():
    ...
    try:
        from lib.entity_graph import EntityGraph
