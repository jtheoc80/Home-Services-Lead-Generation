...
PERMIT_ALIASES = {
    ...
    "status": ["status", "permit_status", "current_status", "state", "permit_state"],
    "permit_type": [
        "permit_type",
        "work_type",
        "project_type",
    ...
    "postal_code": ["zip", "zipcode", "postal_code", "zip_code", "postcode"],
    "parcel_id": [
        "parcel",
        "parcel_id",
        "apn",
    ...
    # Geography
    "latitude": ["latitude", "lat", "y", "location_latitude", "coord_y", "point_y"],
    "longitude": [
        "longitude",
        "lon",
        "long",
    ...
    # Additional fields
    "url": ["url", "record_url", "link", "permit_url", "details_url"],
    # Property details
    "property_owner": ["owner", "property_owner", "owner_name", "property_owner_name"],
    "square_footage": [
        "square_footage",
        "sq_ft",
        "area",
    ...
    "units": ["units", "dwelling_units", "number_of_units", "unit_count"],
    "stories": ["stories", "floors", "number_of_stories", "building_stories"],
}
