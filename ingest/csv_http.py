...
class CSVHTTPConnector:
    ...
    async def extract_updated_since(self, endpoint: str, updated_field: str, since: Optional[datetime], rate_limit: int = 1) -> List[Dict[str, Any]]:
        """
