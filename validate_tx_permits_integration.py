...
def main():
    ...
    try:
        ...
        required_endpoints = ["/api/demo/permits", "/api/leads/scores"]
    ...
    validation_files = [
        (
            "great_expectations/permits_validation.py",
    ...
    if not check_import(
        "great_expectations.permits_validation", "Great Expectations validation import"
    ):
        all_checks_passed = False
    ...
    scoring_files = [("scoring/v0.py", "Scoring algorithm v0")]
    ...
    if all_checks_passed:
        ...
        print(
            "   4. Test pipeline: python -m pipelines.load_raw --only dallas_permits --since 2024-01-01"
        )
