...
def validate_migration_file():
    ...
    if failed == 0:
        ...
        print(
            f"💥 Migration validation FAILED! ({failed} required checks failed, {passed} passed)"
        )
        return False
...
if __name__ == "__main__":
    ...
    try:
        ...
        if all_passed:
            ...
            print(
                "3. Verify with: SELECT source, permit_id, permit_number FROM public.permits WHERE source='selftest'"
            )
        else:
