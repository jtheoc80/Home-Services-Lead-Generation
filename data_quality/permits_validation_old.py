    ...
    def create_expectation_suite(self) -> ExpectationSuite:
        ...
        expectations = [
            ...
            ExpectationConfiguration(
                ...
                kwargs={
                    "column": "status",
                    "value_set": ["ACTIVE", "CLOSED", "PENDING", "CANCELLED", "EXPIRED"],
            ...
            ExpectationConfiguration(
                ...
                kwargs={
                    "column": "city",
                    "value_set": ["Dallas", "Austin", "Arlington", "Houston", "Harris County"],
                    "mostly": 0.95
                }
            ),
    ...
    def validate_permits_data(self, context=None) -> Dict[str, Any]:
        ...
        try:
            ...
            batch_request = {
                ...
                "runtime_parameters": {"query": "SELECT * FROM gold.permits LIMIT 10000"}  # Sample for performance
            }
            ...
            # Log results
            if results.success:
                logger.info(f"Permits validation PASSED: {summary['successful_expectations']}/{summary['total_expectations']} checks")
            else:
                logger.warning(f"Permits validation FAILED: {summary['failed_expectations']}/{summary['total_expectations']} checks failed")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Run data quality validation on gold.permits')
