...
def demo_dallas_socrata():
    ...
    print(
        f"🌐 API Endpoint: https://{dallas_config['domain']}/resource/{dallas_config['dataset_id']}.json"
    )
    print(f"🔄 Incremental Field: {dallas_config['updated_field']}")
    print(f"🔑 Primary Key: {dallas_config['primary_key']}")
    print("📈 Rate Limit: 5 requests/second with exponential backoff")
...
def demo_austin_socrata():
    ...
    print(
        f"🌐 API Endpoint: https://{austin_config['domain']}/resource/{austin_config['dataset_id']}.json"
    )
...
def main():
    ...
    print(
        "• Dallas: https://www.dallasopendata.com/City-Services/Building-Permits/e7gq-4sah"
    )
    print(
        "• Austin: https://data.austintexas.gov/Building-and-Development/Issued-Construction-Permits/3syk-w9eu"
    )
