...
def create_tx_permits_expectations():
    ...
    raw_permits_suite.add_expectation(
        ge.expectations.ExpectColumnValuesToBeInSet(
            ...
            value_set=[
                ...
                "tx-bexar-county", "tx-houston-city", "tx-san-antonio-city",
                "tx-dallas-city", "tx-austin-city", "tx-fort-worth-city",
                "tx-el-paso-city", "tx-arlington-city", "tx-corpus-christi-city",
                "tx-plano-city", "tx-lubbock-city", "tx-houston-tpia"
            ]
        )
    )
    ...
    permits_suite.add_expectation(
        ge.expectations.ExpectColumnToExist(column="address")
    )
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Run Great Expectations validation on TX permits')
