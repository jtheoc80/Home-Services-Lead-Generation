...
for line in sys.stdin:
    ...
    if addr:
        try:
            ...
            street = " ".join(filter(None, [tagged.get("AddressNumber"), tagged.get("StreetNamePreType"),
                                            tagged.get("StreetName"), tagged.get("StreetNamePostType"),
                                            tagged.get("OccupancyType"), tagged.get("OccupancyIdentifier")]))
