...
class TestNormalizeArlingtonPermit:
    ...
    def test_arlington_normalization(self, arlington_permit_sample, arlington_source_meta):
...
class TestValidation:
    ...
    def test_valid_record_passes_validation(self, dallas_permit_sample, dallas_source_meta):
