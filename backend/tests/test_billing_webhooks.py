...
class TestWebhookHandlers:
    ...
    async def test_handle_checkout_completed_subscription(
        self, mock_stripe_sub, mock_supabase
    ):
    ...
    async def test_handle_checkout_completed_credits(
        self, mock_grant_credits, mock_supabase
    ):
