...
class CreditOffer:
    ...
    def savings_vs_oneoff(self, oneoff_cost_per_credit: float) -> float:
        ...
        if oneoff_cost_per_credit <= 0:
            return 0.0
        return max(0.0, (oneoff_cost_per_credit - self.cost_per_credit) / oneoff_cost_per_credit * 100)
    ...
    def calculate_best_value(self, needed_credits: int) -> Dict[str, Any]:
        ...
        for tier, offer in self.credit_offers.items():
            ...
            recommendations.append({
                ...
                'efficiency_score': needed_credits / (needed_credits + waste_credits)
            })
        ...
        return {
            ...
            'all_options': sorted(recommendations, key=lambda x: x['efficiency_score'], reverse=True)
        }
...
class PricingManager:
    ...
    def get_offer_details(self, tier: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            'cost_per_credit': offer.cost_per_credit,
            'savings_vs_oneoff': offer.savings_vs_oneoff(oneoff_cost_per_credit) if oneoff_offer else 0
        }
