...
class CancellationFeedbackService:
    ...
    def calculate_global_source_adjustments(
    ...
    def calculate_personalized_adjustments(
        self, account_id: str, lead_features: Dict[str, Any]
    ) -> float:
        """
        ...
        if preferred_trades and not any(
            tag in preferred_trades for tag in lead_trade_tags
        ):
            adjustment -= 5.0
