...
class SubscriptionAPI:
    ...
    def cancel_subscription(self, request_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            result = self.subscription_manager.cancel_subscription(
                subscription, cancellation_request
            )
            ...
            return {
                ...
                "data": {
                    ...
                    "grace_period_end_date": (
                        subscription.grace_period_end_date.isoformat()
    ...
    def get_cancellation_records(
        self, admin_user_id: str, filters: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        """
    ...
    def _get_cancellation_records_from_db(
