...
def ingest_csv_data(csv_file_path: str) -> int:
    ...
    if not db_url:
        ...
        if supabase_url and supabase_key:
            ...
            raise Exception(
                "DATABASE_URL or SUPABASE_URL/SUPABASE_SERVICE_ROLE_KEY environment variables not set"
            )
    ...
    try:
        ...
        logger.info(
            f"Successfully ingested {records_processed} records from {csv_file_path}"
        )
        return records_processed
