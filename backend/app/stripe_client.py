...
class StripeClient:
    ...
    def _configure_stripe(self):
        ...
        # Billing URLs
        self.success_url = os.getenv("BILLING_SUCCESS_URL", "https://localhost:3000/billing/success")
        self.cancel_url = os.getenv("BILLING_CANCEL_URL", "https://localhost:3000/billing/cancel")
