...
from leadledderpro_client.api_response import ApiResponse, T as ApiResponseT
import leadledderpro_client.models
from leadledderpro_client import rest
from leadledderpro_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(leadledderpro_client.models, klass)
